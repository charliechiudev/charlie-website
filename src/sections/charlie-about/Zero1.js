        ...
        <Container className="">
          <Row className="">
            ...
            <Col xl="8" lg="8" sm="8" className="border-left pl-5 pt-5 pb-5">
              ...
              <Box className="">
                <strong>At RMIT, Charlie transforms creative concepts into tech-driven outcomes. She brings ideas to life through design and multimedia production — developing interactive web-based apps and experiences, producing engaging digital content, and leveraging AI to drive innovative learning and teaching solutions.</strong>
                <p></p>
                <p>Having graduated with Dual Bachelor's Degrees in Marketing and IT, Charlie's early career involved enterprise marketing in a global Food & Beverage enterprise, branding, and graphic designs for small businesses. She soon realised the inseparable relationship between human-centred design, consumer behaviours, and business goals which is why she started to make use of her logical programming skills from her degree in digital media and user experience design. </p>
                <p>As a tech-savvy and strategic thinker, she enjoys solving problems with her diverse skillsets by experimenting with emerging techs. Her logical thinking skills allow her to understand and execute how a project works exactly from user, technical, design, and business perspectives as well as bringing her own design ideas to life. What is more, the solid marketing & branding experiences she has gained in her early career have helped putting herself in customers' shoes whilst still being creative.</p>
