          ...
          <Row className="">
            ...
            <Col xl="8" lg="8" sm="8" className="border-left pl-5 pt-5 pb-5">
              ...
              <Box className="">
                ...
                <p>Chrlie's recent role as the <strong>Experience & Design Lead</strong> at ASPL Group - a management consultancy that offers innovative training and recruitment solutions, focusses on aligning people, processes, and systems, with a base primarily consists of organisations within the Australian public sector, spanning both federal and state government institutions. Some of the major clients includes Department of Defence, Australia, Department of Education and Training, VIC, Roper Gulf Regional Council, NT,  and National Emergency Management Agency.</p>
